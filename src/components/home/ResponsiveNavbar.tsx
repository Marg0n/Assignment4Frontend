...
const ResponsiveNavbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full h-auto shadow-md p-4 bg-gradient-to-r from-blue-100 via-blue-400 to-purple-300 border-purple-300 shadow-purple-300 sticky top-0 z-50">
